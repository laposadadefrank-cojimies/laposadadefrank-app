  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        {/* Botón Calendario -> apunta a la carpeta /reservas */}
        <Link 
          href="/reservas" 
          className="bg-white p-10 rounded-2xl shadow-xl hover:scale-105 transition transform flex flex-col items-center border-t-4 border-blue-500"
        >
        ...
        {/* Botón Habitaciones -> apunta a la carpeta /habitaciones */}
        <Link 
          href="/habitaciones" 
          className="bg-white p-10 rounded-2xl shadow-xl hover:scale-105 transition transform flex flex-col items-center border-t-4 border-green-500"
        >
          <span className="text-6xl mb-4">🏨</span>
