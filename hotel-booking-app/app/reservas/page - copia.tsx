          ...
          <div className="bg-white rounded-[2rem] p-6 w-full max-w-2xl shadow-2xl max-h-[95vh] overflow-y-auto border-t-[10px] border-blue-600">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="md:col-span-2">
                  <label className="text-[9px] font-black text-gray-400">HUÉSPED</label>
                ...
                <div><label className="text-[9px] font-black uppercase text-gray-400">N° Pers.</label><input type="number" value={nuevaReserva.num_personas} className="w-full p-2 border rounded-lg font-bold text-xs" onChange={e => setNuevaReserva({...nuevaReserva, num_personas: parseInt(e.target.value) || 1})} /></div>
                <div><label className="text-[9px] font-black uppercase text-gray-400">Precio p/p</label><input type="number" value={nuevaReserva.precio_persona} className="w-full p-2 border rounded-lg font-bold text-xs" onChange={e => setNuevaReserva({...nuevaReserva, precio_persona: parseFloat(e.target.value) || 0})} /></div>
                ...
                <div>
                  <label className="text-[9px] font-black uppercase text-green-600">Abono</label>
                  <input type="number" value={nuevaReserva.anticipo} className="w-full p-2 border-2 border-green-200 rounded-lg font-black text-green-600 text-xl" onChange={e => setNuevaReserva({...nuevaReserva, anticipo: parseFloat(e.target.value) || 0})} />
                </div>
                <div>
                  <label className="text-[9px] font-black uppercase">Pago</label>
                ...
                <div className="md:col-span-2">
                  <label className="text-[9px] font-black uppercase text-gray-400">Observaciones</label>
                  <textarea value={nuevaReserva.observaciones} className="w-full p-2 border rounded-lg font-medium text-[11px] h-16" onChange={e => setNuevaReserva({...nuevaReserva, observaciones: e.target.value})} />
                </div>
             </div>
